				...
				<section class="s-12 l-7">
							...
							<div class="span12">
								...
								<table align="center">
									...
									<tr>
										...
										<td>
											<div>
												<input type="text" name="height1" value="" />Cm ~ <input
													type="text" name="height2" value="" />Cm
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<div>
												<input type="text" name="height1" value="" />Kg ~ <input
													type="text" name="height2" value="" />Kg
											</div>
										</td>
									</tr>
									<tr>
					...
					<div class="container">
						<div class="row">
							<div class="span12">
								<div align="center">
									<input class="btn-custom" type="submit" value="가입 완료"
										style="width: 150px; height: 35px" />&nbsp;&nbsp;&nbsp; <input
