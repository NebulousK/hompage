...
$noo = $row5[no]+1;
$sql = "insert into asan1file(no,filename,desination,filesize,filetype,fileurl) ";
$sql .= "values($noo,'$filename', '$desination', '$filesize', '$filetype', '$fileurl')";
