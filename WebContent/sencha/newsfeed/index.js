function getreplylist(no, name){
	//var o = "#replydiv"+no;
	//var id = document.getElementById("replydiv"+no);
	$("#replydiv"+no).load("/homepage/newsfeed/replyproc1.jsp?no="+no+"&id="+name+"&index="+no);
	//alert(no+ name);
};
    ...
    onReady : function() {
        ...
        var someboard_list = new Ext.List({
    		...
    		itemTpl: '<tpl for=".">'
        		...
        		+'</tpl>'
        		+'</span></span>'
        		+'<img src="/homepage/images/icon/iconmonstr-facebook-like-icon-256.png" style="width: 12px;height:12px;" />&nbsp;'
