...
include "../../dbconn.php";
$no=$_GET[no];
$sql = "select * from meetasan where no=$no";
$result = mysql_query($sql, $connect);
$row = mysql_fetch_array($result);
$check = $_POST[password];
if($row[passwd] != $check){
	echo "<script> window.alert('비밀번호가 일치 하지 않습니다.')
	history.go(-1)</script>";
}
?>
<div class="body">
<div id="wrapper"> <!-- 가장 큰 틀 -->
     
    	<?php include '../menu.php';?>
   	  <div id="main"> <!-- 주요내용이 들어갈곳 -->
        	
            <div id="main_category">
            	
                <div id="main_category_banner">
                	<img src="/home_image/ca03.jpg" />
                </div>
                
                <div id="main_category_detail">
                
                	<table width="200px" height="150px">
                    	
                        <tr>
                        	<td><img src="/home_image/caup.jpg" /> </td>
                        </tr>
                        <tr>
                        	<td><A href='/menu3/menu1/board.php' onfocus='this.blur();' style='color:white;'><img src="/home_image/menu3-1-1.jpg" id="Image6" onmouseover="MM_swapImage('Image6','','/home_image/menu3-1-2.jpg',1)" onmouseout="MM_swapImgRestore()" /></A></td>
                        </tr>
                        <tr>
                        	<td><A href='/menu3/menu2/board.php' onfocus='this.blur();' style='color:white;'><img src="/home_image/menu3-2-1.jpg" id="Image7" onmouseover="MM_swapImage('Image7','','/home_image/menu3-2-2.jpg',1)" onmouseout="MM_swapImgRestore()" /></a></td>
                        </tr>
                        <tr>
                        	<td>&nbsp;</td>
                        </tr>
                        <tr>
                        	<td><img src="/home_image/camenudown.jpg" /></td>
                        </tr>
            ...
            <div id="main_border">
                ...
                <div id="main_border_up">
                	<img src="/home_image/boradupmenu3-1.jpg" />
                </div>
                
                <div id="main_border_down">
                 
                 <div id='blnk' style="height:30px;">&nbsp;</div>
	<!-- 에디터 시작 -->
	<!--
		@decsription
		등록하기 위한 Form으로 상황에 맞게 수정하여 사용한다. Form 이름은 에디터를 생성할 때 설정값으로 설정한다.
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="test.php?kind=edit" method="post" accept-charset="utf-8">
		<div id="board_title">
		<div id="board_1">제목<input type="hidden" name="kind" value="edit" size="60" maxlength="60">
		<input type="hidden" name="no" value="<?php echo $row[no]?>" size="60" maxlength="60"></div>
		<div id="board_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title" value="<?php echo $row[subject]?>" size="60" maxlength="60"></div>
		</div>
		<div id="board_name">
		<div id="board_1">작성자</div>
		<div id="board_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row[name]?></div>
		</div>
		<div id="board_passwd">
		<div id="board_1">비밀번호</div>
		<div id="board_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="passwd" value="<?php echo $row[passwd]?>" size="60" maxlength="60"></div>
		</div>
		<!-- 에디터 컨테이너 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<a href="#" onclick='saveContent()'><img src="/board/freeboard/image/write.gif" align=right border=0 ></a>
		<!-- 에디터 컨테이너 끝 -->
	</form>
</div>
<!-- 에디터 끝 -->
...
<!-- Loading Contents -->
<textarea id="load_contents_source" style="display:none;"><?php echo $row[content]?></textarea>
<script type="text/javascript">
		Editor.modify({"content": document.getElementById("load_contents_source")});
</script>
</body>
</html>