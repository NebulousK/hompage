...
<div class="section">
			...
			<p> 이 약관은 SomeNSome (&quot;회사&quot; 또는 &quot;SomeNSome&quot;)가 제공하는 SomeNSome 및 SomeNSome 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
			<h3>
			...
			<ol>
			<li><span class="first_letter">①</span>&quot;서비스&quot;라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 &quot;회원&quot;이 이용할 수 있는 SomeNSome 및 SomeNSome 관련 제반 서비스를 의미합니다. </li>
