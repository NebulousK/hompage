	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(action.equals("/dash.some")){
			...
			if(list.size() > i){
				...
				out.print("<div id='start' name='start'><div class='_4-u2 mbm _5jmm _5pat _5v3q _5sq8 _5x16' id='u_ps_0_0_m'><div class='userContentWrapper _5pcr _3ccb'><div class='_4r_y'><div class='_6a uiPopover _5pbi _5puc _5v56' id='u_ps_0_0_n'></div></div><div class='clearfix _5x46'><div class='_3dp _29k'><div><div class='_6a'><div class='_6a _6b'><h5 class='_5pbw'><div class='fwn fcg'><table style='border: 0px;width: 554px'><tr><td style='border: 0px;width: 55px; padding: 0px;margin: 0px;'><a class='_5pb8 _5v9u _29h _303' href='/homepage/itsme/main2.jsp?id="+ dto.getId() + "'><img class='_s0 _5xib _5sq7 _rw img' src='/homepage/profile/" + dto.getPhoto() + "' alt='' align='middle' /></a></td><td style='border: 0px;text-align: left;'><span class='fwb fcg'><a href='/homepage/itsme/main2.jsp?id="+ dto.getId() + "' style='font-size: 14px;'>"+ dto.getId() + "</a></span><br/><div class='_5pcp' style='margin-top: 5px'><span>" + dto.getDay() + "</span></div></td><td style='border: 0px;text-align: right;'>");
